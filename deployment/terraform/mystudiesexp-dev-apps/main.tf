...
module "project" {
  ...
  name                    = "mystudiesexp-dev-apps"
  org_id                  = ""
  folder_id               = "345965624178"
  billing_account         = "01F033-6917A2-E29764"
  lien                    = true
  default_service_account = "keep"
  skip_gcloud_download    = true
  shared_vpc              = "mystudiesexp-dev-networks"
  shared_vpc_subnets = [
    "projects/mystudiesexp-dev-networks/regions/us-central1/subnetworks/mystudiesexp-dev-gke-subnet",
  ]
  activate_apis = [
...
module "mystudiesexp_dev" {
  source  = "terraform-google-modules/cloud-dns/google"
  version = "~> 3.0.0"

  name       = "mystudiesexp-dev"
  project_id = module.project.project_id
  domain     = "mystudiesexp-dev.riberasolutions.com."
  type       = "public"
...
module "mystudiesexp_dev_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 11.1.0"

  # Required.
  name               = "mystudiesexp-dev-gke-cluster"
  project_id         = module.project.project_id
  region             = "us-central1"
  regional           = true
  network_project_id = "mystudiesexp-dev-networks"

  network                = "mystudiesexp-dev-network"
  subnetwork             = "mystudiesexp-dev-gke-subnet"
  ip_range_pods          = "mystudiesexp-dev-pods-range"
  ip_range_services      = "mystudiesexp-dev-services-range"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@mystudiesexp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@mystudiesexp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@mystudiesexp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@mystudiesexp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@mystudiesexp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@mystudiesexp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@mystudiesexp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@mystudiesexp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@mystudiesexp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@mystudiesexp-dev-apps.iam.gserviceaccount.com",
    ],
  }
}
