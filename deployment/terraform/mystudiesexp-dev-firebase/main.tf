...
terraform {
  ...
  backend "gcs" {
    ...
    prefix = "mystudiesexp-dev-firebase"
  }
}
...
module "project" {
  ...
  name                    = "mystudiesexp-dev-firebase"
  org_id                  = ""
...
module "mystudiesexp_dev_mystudies_firestore_raw_data" {
  source  = "terraform-google-modules/cloud-storage/google//modules/simple_bucket"
  version = "~> 1.4"

  name       = "mystudiesexp-dev-mystudies-firestore-raw-data"
  project_id = module.project.project_id
