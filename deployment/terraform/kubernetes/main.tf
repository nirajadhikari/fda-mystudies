...
data "google_secret_manager_secret_version" "secrets" {
  ...
  project  = "mystudiesexp-dev-secrets"
  secret   = each.key
...
resource "kubernetes_secret" "shared_secrets" {
  ...
  data = {
    consent_bucket_name               = "mystudiesexp-dev-mystudies-consent-documents"
    study_resources_bucket_name       = "mystudiesexp-dev-mystudies-study-resources"
    study_export_import_bucket_name   = "mystudiesexp-dev-mystudies-sql-import"
    institution_resources_bucket_name = "mystudiesexp-dev-mystudies-institution-resources"
    base_url                          = "https://participants.mystudiesexp-dev.riberasolutions.com"
    studies_base_url                  = "https://studies.mystudiesexp-dev.riberasolutions.com"
    firestore_project_id              = "mystudiesexp-dev-firebase"
...
resource "google_service_account_key" "apps_service_account_keys" {
  ...
  service_account_id = "${each.key}@mystudiesexp-dev-apps.iam.gserviceaccount.com"
}
