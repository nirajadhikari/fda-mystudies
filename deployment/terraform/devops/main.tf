...
module "state_bucket" {
  ...
  name       = "mystudiesexp-dev-terraform-state"
...
resource "google_project_iam_binding" "devops_owners" {
  ...
  role    = "roles/owner"
  members = ["group:mystudiesexp-dev-devops-owners@riberasolutions.com"]
}

# Org level IAM permissions for org admins.
resource "google_folder_iam_member" "admin" {
  folder = "folders/345965624178"
  role   = "roles/resourcemanager.folderAdmin"
  member = "group:mystudiesexp-dev-folder-admins@riberasolutions.com"
}
