...
terraform {
  ...
  backend "gcs" {
    bucket = "exp-dev-terraform-state"
    prefix = "exp-dev-apps"
  }
}
...
module "project" {
  ...
  shared_vpc              = "exp-dev-networks"
  shared_vpc_subnets = [
    "projects/exp-dev-networks/regions/us-central1/subnetworks/exp-dev-gke-subnet",
  ]
  activate_apis = [
...
module "exp_dev" {
  ...
  domain     = "exp-dev.riberasolutions.com."
  type       = "public"
...
module "exp_dev_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 11.1.0"

  # Required.
  name               = "exp-dev-gke-cluster"
  project_id         = module.project.project_id
  region             = "us-central1"
  regional           = true
  network_project_id = "exp-dev-networks"

  network                = "exp-dev-network"
  subnetwork             = "exp-dev-gke-subnet"
  ip_range_pods          = "exp-dev-pods-range"
  ip_range_services      = "exp-dev-services-range"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@exp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@exp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@exp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@exp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@exp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@exp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@exp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@exp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@exp-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@exp-dev-apps.iam.gserviceaccount.com",
    ],
  }
}
