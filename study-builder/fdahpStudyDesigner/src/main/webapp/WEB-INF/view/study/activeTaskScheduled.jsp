...
<script type="text/javascript">
  ...
  function addDate() {
    ...
    var newDateCon = "<div class='manually-option mb-md form-group' id='RegDate" + customCount + "'>"
        ...
        + "' required name='activeTaskCustomScheduleBo[" + customCount
        + "].frequencyEndTime' class='form-control clock customTime cusTime endTime' data-error='Please fill out this field'  placeholder='End time' onclick='timep(this.id);' disabled/>"
        + "<span class='help-block with-errors red-txt'></span>"
        + "  </span>"
