...
public class StudyExportSqlQueries {
  ...
  public static final String CONSENT_MASTER_INFO =
      "INSERT INTO `consent_master_info` (`id`, `title`, `type`, `code`, `study_version`) VALUES (<id>, <title>, <type>, <code>, <study_version>);";

  public static final String ELIGIBILITY =
      "INSERT INTO `eligibility` (`id`, `created_by`, `created_on`, `eligibility_mechanism`, `failure_outcome_text`, `instructional_text`, `modified_by`, `modified_on`, `study_id`, `study_version`) VALUES (<id>, <created_by>, <created_on>, <eligibility_mechanism>, <failure_outcome_text>, <instructional_text>, <modified_by>, <modified_on>, <study_id>, <study_version>);";
  ...
  public static final String INSTRUCTIONS =
      "INSERT INTO `instructions` (`id`, `active`, `created_by`, `created_on`, `instruction_text`, `instruction_title`, `modified_by`, `modified_on`, `status`, `study_version`) VALUES (<id>, <active>, <created_by>, <created_on>, <instruction_text>, <instruction_title>, <modified_by>, <modified_on>, <status>, <study_version>);";
  ...
  public static final String STUDY_PAGE =
      "INSERT INTO `study_page` (`page_id`, `created_by`, `created_on`, `description`, `image_path`, `modified_by`, `modified_on`, `study_id`, `title`, `study_version`) VALUES (<page_id>, <created_by>, <created_on>, <description>, <image_path>, <modified_by>, <modified_on>, <study_id>, <title>, <study_version>);";
