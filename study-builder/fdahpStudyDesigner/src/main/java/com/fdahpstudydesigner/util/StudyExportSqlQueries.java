...
public class StudyExportSqlQueries {
  ...
  public static final String ACTIVETASK_MASTER_ATTRIBUTE =
      "INSERT INTO `active_task_master_attribute` (`active_task_master_attr_id`, `add_to_dashboard`, `attribute_data_type`, `attribute_name`, `attribute_type`, `display_name`, `order_by`, `task_type_id`) VALUES (<active_task_master_attr_id>, <add_to_dashboard>, <attribute_data_type>, <attribute_name>, <attribute_type>, <display_name>, <order_by>, <task_type_id>);";
  ...
  public static final String ACTIVETASK_FORMULA =
      "INSERT INTO `activetask_formula` (`activetask_formula_id`, `value`) VALUES (<activetask_formula_id>, <value>);";
